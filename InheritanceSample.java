public class InheritanceSample
{
	public static void main(String[] args) {
		Student student1 = new Student("Marriel", "Brgy. Cahil, Calaca City, Batangas", "BSIT", 2);
		...
		Staff staff1 = new Staff("Mia Alexa Tindoc", "Brgy. Puting Bato West, Calaca City, Batangas", "Batangas State University", 399.00f );
